...
public class Keer_OptionBtns_ColorChange : MonoBehaviour
{
    ...
    [SerializeField] Button optionButton_keer_2;
    [SerializeField] Button optionButton_keer_3;
    [SerializeField] Button optionButton_keer_4;
    [SerializeField] Button optionButton_keer_5;
    [SerializeField] Button optionButton_keer_6;
    [SerializeField] Button optionButton_keer_7;
    [SerializeField] Button optionButton_keer_8;
    [SerializeField] Button optionButton_keer_9;
    [SerializeField] Button optionButton_keer_random;
